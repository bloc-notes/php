<?php
   ...
   require_once("classe-mysql-2018-03-23-Doyon.php");
...
<?php
   ...
   */
   ...
   mysqli_query($BDExercice4->cBD, "DROP TABLE $strNomTable1");
   mysqli_query($BDExercice4->cBD, "DROP TABLE $strNomTable2");
