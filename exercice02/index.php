<?php
   ...
   //Lecture fichier bottin.txt et entrepose donnée dans tableau
    ...
    $strDateTempo = call_user_func($strModeTransmission,"tbDateDuJour");
    ...
    $strMoisCourant = call_user_func($strModeTransmission,"ddlMoisCourant");
    ...
    //Problème 4
    $strProbleme = call_user_func($strModeTransmission,"ddlProbleme");
