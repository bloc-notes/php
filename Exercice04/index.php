<?php
   ...
   require_once("classe-mysql-2017-04-10.php");
...
<?php
   ...
   */
   ...
   if ($strNomServeur == "lmbrousseau.ca") {
      $strLocalHost = "mysql.hostinger.fr";
      $strNomBD = "";
   }
   ...
   $BDExercice4 = new mysql($strNomBD, $strInfosSensibles);
   $strVerdict = $BDExercice4->_cBD->stat;
   ...
   $strVerdict = "Sélection de la base de données <span class=\"sGras\">'$BDExercice4->_nomBD'</span> " . ($BDExercice4->_OK ? "confirmée" : "impossible");
   requeteExecutee("2. selectionneBD()", "mysqli_select_db(\$cBD, $BDExercice4->_nomBD)", $strVerdict);
   poursuiteTraitement($BDExercice4->_OK);
   
   /* --- Aux fins de la démonstration seulement, suppression des tables existantes */
   mysqli_query($BDExercice4->_cBD, "DROP TABLE $strNomTable1");
   mysqli_query($BDExercice4->_cBD, "DROP TABLE $strNomTable2");
   ...
   $BDExercice4->creeTable($strNomTable1,
                    ...
                    "PRIMARY KEY(NoApp)");
   $strVerdict = "Création de la table <span class=\"sGras\">'$strNomTable1'</span> " . ($BDExercice4->_OK ? "confirmée" : "impossible");
   requeteExecutee("3.1 creeTable()", $BDExercice4->_requete, $strVerdict);
   ...
   $BDExercice4->creeTable($strNomTable1,
                    ...
                    "PRIMARY KEY(NoApp)");
   $strVerdict = "Création de la table <span class=\"sGras\">'$strNomTable1'</span> " . ($BDExercice4->_OK ? "confirmée" : "impossible");
   requeteExecutee("3.2 creeTable()", $BDExercice4->_requete, $strVerdict);

   /* --- Suppression de la structure de la 1re table (RÉUSSITE) --- */
   $BDExercice4->supprimeTable($strNomTable1);
   $strVerdict = "Suppression de la table <span class=\"sGras\">'$strNomTable1'</span> " . ($BDExercice4->_OK ? "confirmée" : "impossible");
   requeteExecutee("4.1 supprimeTable()", $BDExercice4->_requete, $strVerdict);
   ...
   requeteExecutee("4.2 supprimeTable()", $BDExercice4->_requete, $strVerdict);
   ...
   $strVerdict = "Création de la table <span class=\"sGras\">'$strNomTable1'</span> " . ($BDExercice4->_OK ? "confirmée" : "impossible");
   requeteExecutee("5. creeTable()", $BDExercice4->_requete, $strVerdict);
   ...
   $strVerdict = "Création de la table <span class=\"sGras\">'$strNomTable2'</span> " . ($BDExercice4->_OK ? "confirmée" : "impossible");
   requeteExecutee("6. creeTableGenerique()", $BDExercice4->_requete, $strVerdict);
   ...
   $BDExercice4->insereEnregistrement($strNomTable1,
                    ...
                    20,
                    "Lebel, Jean-Claude");
   $strVerdict = "Ajout de l'enregistrement " . ($BDExercice4->_OK ? "confirmé" : "impossible");
   requeteExecutee("7.$intNo insereEnregistrement()", $BDExercice4->_requete, $strVerdict);
   ...
   while (!$fichierEmploye->detecteFin()) {
      ...
      $tValeurs["Homme"] = $tValeurs["Homme"] == "oui" || $tValeurs["Homme"] == "true" ? "true" : ($tValeurs["Homme"] == "non" || $tValeurs["Homme"] == "false" ? "false" : null);
      ...
      $BDExercice4->insereEnregistrement($strNomTable1,
                       ...
                       $tValeurs["NomComplet"]);
      $strVerdict = "Ajout de l'enregistrement " . ($BDExercice4->_OK ? "confirmé" : "impossible");
      requeteExecutee("7.$intNo insertionEnregistrement()", $BDExercice4->_requete, $strVerdict);
   }
   ...
   $strVerdict = "Copie de tous les enregistrements de la table '$strNomTable1' dans la table '$strNomTable2' " . ($BDExercice4->_OK ? "confirmée" : "impossible");
   requeteExecutee("8. copieEnregistrements()", $BDExercice4->_requete, $strVerdict);
   ...
   $strVerdict = "Suppression des enregistrements de la table '$strNomTable2' dont le numéro >= 1005 " . ($BDExercice4->_OK ? "confirmée" : "impossible");
   requeteExecutee("9. supprimeEnregistrements()", $BDExercice4->_requete, $strVerdict);
   ...
   $strVerdict = "Changement du nom du champ 'NomComplet' pour 'NomCourtier' de la table '$strNomTable2' " . ($BDExercice4->_OK ? "confirmé" : "impossible");
   requeteExecutee("10. modifieChamp()", $BDExercice4->_requete, $strVerdict);
   ...
   $strVerdict = "Copie des enregistrements de la table '$strNomTable1' dont le numéro >= 1006 dans la table '$strNomTable2' " . ($BDExercice4->_OK ? "confirmée" : "impossible") . " (1005 disparaît de '$strNomTable2')";
   requeteExecutee("11. copieEnregistrements()", $BDExercice4->_requete, $strVerdict);
   ...
   $strVerdict = "Suppression de tous les enregistrements de la table '$strNomTable1' " . ($BDExercice4->_OK ? "confirmée" : "impossible");
   requeteExecutee("12.1 suppressionEnregistrements()", $BDExercice4->_requete, $strVerdict);
   ...
   $BDExercice4->supprimeEnregistrements($strNomTable2, $strListeConditions);
   $strVerdict = "Suppression des enregistrements de la table '$strNomTable2' dont le numéro d'employé est impair " . ($BDExercice4->_OK ? "confirmée" : "impossible");
   requeteExecutee("12.2 suppressionEnregistrements()", $BDExercice4->_requete, $strVerdict);
