...
//$_SESSION["pageAvant"]="menuAdmin.php";
?>
...
<div>
    ...
    <ul class="sCentre sMenu">
        <li class="">
            <a onclick="<?php $_SESSION["pageAvant"]="menuAdmin.php"; ?>soumettrePageEtat(0,'option1.php');">
        ...
        <li class="">
            <a onclick="<?php $_SESSION["pageAvant"]="menuAdmin.php"; ?>soumettrePageEtat(0,'option2.php');">
        ...
        <li class="">
            <a onclick="<?php $_SESSION["pageAvant"]="menuAdmin.php"; ?>window.location.href = 'option3.php'">
        ...
        <li class="">
            <a onclick="<?php $_SESSION["pageAvant"]="menuAdmin.php"; ?>window.location.href = 'option4.php'">
        ...
        <li class="">
            <a onclick="<?php $_SESSION["pageAvant"]="menuAdmin.php"; ?>window.location.href = 'option5.php'">
