...
//classe fichier 08-05-2018
    class fichier {
        ...
        */
           ...
           * supprime() (08-05-2018)
           * 
           * But: Supprimer le fichier de facon définitive, fermer le fichier si ouvert.
           * --------------------------------------------------------------------------
           */
          function supprime() {
              //Si ouvert, ferme le fichier
              if ($this->fp) {
                  $this->ferme();
              }
              $binVerdict = FALSE;
