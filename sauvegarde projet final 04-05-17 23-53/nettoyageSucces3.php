...
if($oBD->supprimeEnregistrements($strTableAnnonces,"ETAT=3"))
{
	echo "Suppression des annonces avec succès !";
}
 
else
{
	echo "La suppression des annonces a rencontré un problème !";
}
?>
	</table>
