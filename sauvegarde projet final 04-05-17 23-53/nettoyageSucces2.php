...
if($oBD->supprimeEnregistrements($strTableUtilisateur,"STATUT=0 AND CREATION < DATE_ADD(NOW(),INTERVAL 90 DAY)"))
{
	echo "Les utilisateurs ont été supprimés avec succès !";
}
else
{
	echo "La suppresion des utilisateurs a rencontré un problème !";
}
?>
	</table>
