...
<?php 
  ...
  $oBD->selectionneEnregistrements($strTableUtilisateur,"C=STATUT=0 AND CREATION < DATE_ADD(NOW(),INTERVAL 90 DAY)");
...
<table>
<form></form>
<form action="http://424w.cgodin.qc.ca/qwerty/nettoyageSucces2.php">
