...
$strNomFichierCSS = "laboratoire04.css";
...
$strMethode = get("btnEnvoiGET") ? "G":(post("btnEnvoiPOST") ? "P":"");

/*Change la lettre pour le terme utilisé*/
$strMethode = $strMethode == "G"?"get":($strMethode=="P"?"post":"");
...
if($chrSexe == "N/A"){
    ...
    . "location.href='http://424w.cgodin.qc.ca/pdoyon/Laboratoire04/index.htm';</script>";
}
