...
//vérification dans base de donné
    ...
    $BDAnnonce->_requete = "UPDATE `annonces_qwerty`.`connexions` SET `Deconnexion` = $date "
                            . "WHERE `connexions`.`NoConnexion` = $NoConnexion;";*/ //SELECT * FROM `connexions`WHERE `NoConnexion`= (SELECT MAX(`NoConnexion`) FROM `connexions`)
    $BDAnnonce->_requete = "UPDATE `annonces_qwerty`.`connexions` SET `Deconnexion` = '$date' "
                            . "WHERE `connexions`.`NoConnexion` = '(SELECT MAX(`NoConnexion`) FROM `annonces_qwerty`.`connexions`)'";
