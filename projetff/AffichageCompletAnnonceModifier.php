            ...
            <tr>
                <td colspan="3">
                 <p style="color: #18A3FA;">Description courte</p>
                    ...
                    <td  colspan="1" rowspan="3">
                        <input id="btnModifier" name="btnModifier" type="button" value="Modifier" class="btn"  onclick="afficherMessages()" />
                    </td>
                    <td  colspan="1" rowspan="3">
                        <input id="btnSupprimer" name="btnSupprimer" type="button" value="Supprimer" class="btn"  onclick="afficherMessages()" />
                    </td>
                </tr>
</table>
</div>
