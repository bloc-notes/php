            ...
            if($tabInfo['MotDePasse'] == $strMDP){
                ...
                if($_SESSION["Statut"] == 0){
                    ...
                    $BDAnnonce->_requete = "UPDATE `annonces_qwerty`.`utilisateurs` SET `Statut` = '9' "
                            . "WHERE `utilisateurs`.`NoUtilisateur` ='" . $_SESSION["NoUtilisateur"]."'";
...
<div align="center">
	...
	<tr>
	    <td><input id="tbMDP" name="tbMDP" type="password" class="textbox" placeholder="Mot de passe"><br></td>
	</tr>
	<tr>
